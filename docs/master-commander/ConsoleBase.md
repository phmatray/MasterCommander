...
```csharp
public abstract class ConsoleBase : MasterCommander.Core.Display.IConsole
```

Inheritance [System\.Object](https://learn.microsoft.com/en-us/dotnet/api/system.object 'System\.Object') &#129106; ConsoleBase
