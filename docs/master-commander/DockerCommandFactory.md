...
```csharp
public class DockerCommandFactory : MasterCommander.Integrations.Processes.CommandBuilder, MasterCommander.Commanders.Docker.IDockerCommandFactory
```

Inheritance [System\.Object](https://learn.microsoft.com/en-us/dotnet/api/system.object 'System\.Object') &#129106; [CommandBuilder](CommandBuilder.md 'MasterCommander\.Integrations\.Processes\.CommandBuilder') &#129106; DockerCommandFactory
